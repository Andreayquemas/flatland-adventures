...
function jugar() {
	if(pausado) {
		...
		pintor.fillRect(0, 0, 200, 200);
		pintor.fillStyle = "orange";
		pintor.fillRect(10, 10, 180, 180);
		pintor.font = "20px Tahoma";
		pintor.fillStyle = "#fff";
		pintor.fillRect(15, 15, 170, 170);
		pintor.fillStyle = "pink";
		pintor.fillText("Pausado", 55, 33);
		pintor.font = "20px Tahoma";
		pintor.fillStyle = "blue";
		pintor.fillText("Up = W", 60, 60);
		pintor.font = "20px Tahoma";
		pintor.fillStyle = "blue";
		pintor.fillText("Down = S", 50, 90);
		pintor.font = "20px Tahoma";
		pintor.fillStyle = "blue";
		pintor.fillText("Right = D", 20, 120);
		pintor.font = "20px Tahoma";
		pintor.fillStyle = "blue";
		pintor.fillText("Left = A", 30, 150);
		pintor.font = "20px Tahoma";
		pintor.fillStyle = "bue";
		pintor.fillText("Resume = P", 20, 180);
	} else {
		actualizar();
		pintar();
	}
